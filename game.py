...
class Game:
    ...
    def reset(self):
        ...
        self.board[tuple(self.players[0])] = 2
        self.board[tuple(self.players[1])] = 3
        self.player_turn = 0
    ...
    def step(self, action):
        ...
        if not failed:
            self.board[tuple(player_pos)] = 2 + self.player_turn
        self.player_turn = (self.player_turn + 1) % 2
        return (self.board, self.players), -10 if failed else -2 ,failed
